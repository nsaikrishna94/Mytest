...
xu = xlsread('airfoil_data.xlsx','A1:A70')*c;            % Array of x co-ordinates of points of top surface
xd = xlsread('airfoil_data.xlsx','C1:C68')*c;            % Array of x co-ordinates of points of bottom surface

% y co-ordinates of points on airfoil
yu = xlsread('airfoil_data.xlsx','B1:B70')*c;            % Array of y co-ordinates of points of top surface
yd = xlsread('airfoil_data.xlsx','D1:D68')*c;            % Array of y co-ordinates of points of bottom surface
